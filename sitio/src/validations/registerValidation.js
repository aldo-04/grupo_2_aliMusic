...
module.exports=[
    check("firstName").notEmpty().withMessage("Debes indicar tu nombre"),
    ...
    check("email").isEmail().withMessage("debes ingresar un email").notEmpty().withMessage("Debes indicar tu email"),
